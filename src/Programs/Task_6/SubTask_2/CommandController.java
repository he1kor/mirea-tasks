...
public class CommandController {
    ...
    public void doCreatingRectangleCommand(){
        System.out.println("Enter x value of first corner: ");
        int x1 = Input.getInt();
        System.out.println("Enter y value of first corner: ");
        int y1 = Input.getInt();
        System.out.println("Enter x value of second corner: ");
        int x2 = Input.getInt();
        System.out.println("Enter y value of second corner: ");
        int y2 = Input.getInt();
        System.out.println("Enter x speed value of rectangle: ");
        int xSpeed = Input.getInt();
        System.out.println("Enter y speed value of rectangle: ");
        int ySpeed = Input.getInt();
        controller.createShape(new MovableRectangle(x1,y1,x2,y2,xSpeed,ySpeed));
    }
